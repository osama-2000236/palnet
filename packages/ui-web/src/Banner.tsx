    ...
    >
      ...
      {dismissible && onDismiss ? (
        <button
          ...
          className="text-ink-muted hover:text-ink focus-visible:ring-brand-500 inline-flex h-6 w-6 items-center justify-center rounded focus:outline-none focus-visible:ring-2"
        >
