...
export function RetryChip({ onRetry, label, loading, inline }: RetryChipProps): ReactElement {
  return (
    <button
      ...
      className={
        "text-brand-700 hover:text-brand-800 inline-flex items-center gap-1 rounded-md text-xs font-semibold focus-visible:outline-none focus-visible:[box-shadow:var(--focus-ring)] disabled:cursor-not-allowed disabled:opacity-60 " +
