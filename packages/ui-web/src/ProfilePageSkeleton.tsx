...
export function ProfilePageSkeleton(): JSX.Element {
  return (
    <main
      className="mx-auto flex w-full max-w-[840px] flex-col gap-6 px-6 py-8"
      aria-hidden="true"
    >
      {/* Cover */}
      <div className="h-40 w-full animate-pulse rounded-lg bg-surface-subtle sm:h-52" />

      {/* Hero: avatar + name block + action */}
      <Surface as="section" variant="hero" padding="6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-start gap-4">
            <div className="h-20 w-20 shrink-0 animate-pulse rounded-full bg-surface-subtle" />
          ...
          <div className="h-9 w-28 animate-pulse rounded-md bg-surface-subtle" />
        </div>
      </Surface>
      ...
      <Surface as="section" variant="card" padding="6">
        <div className="flex flex-col gap-2">
          <div className="mb-1 h-5 w-24 animate-pulse rounded bg-surface-subtle" />
          <div className="h-3.5 w-[94%] animate-pulse rounded bg-surface-subtle" />
          <div className="h-3.5 w-[88%] animate-pulse rounded bg-surface-subtle" />
          <div className="h-3.5 w-[72%] animate-pulse rounded bg-surface-subtle" />
        </div>
      </Surface>
