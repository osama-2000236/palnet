...
export const ErrorCode = {
  ...
  VERIFICATION_DOMAIN_UNKNOWN: "VERIFICATION_DOMAIN_UNKNOWN",
  VERIFICATION_ALREADY_VERIFIED: "VERIFICATION_ALREADY_VERIFIED",
  RECOMMENDATION_SELF: "RECOMMENDATION_SELF",
  RECOMMENDATION_DUPLICATE: "RECOMMENDATION_DUPLICATE",
  WORK_PROOF_SELF_CONFIRM: "WORK_PROOF_SELF_CONFIRM",
  WORK_PROOF_NOT_PENDING: "WORK_PROOF_NOT_PENDING",
  WORK_PROOF_DUPLICATE: "WORK_PROOF_DUPLICATE",
  VOUCH_NOT_ELIGIBLE: "VOUCH_NOT_ELIGIBLE",
  VOUCH_CAP_REACHED: "VOUCH_CAP_REACHED",
  VOUCH_SUSPENDED: "VOUCH_SUSPENDED",
  LICENCE_DUPLICATE: "LICENCE_DUPLICATE",
} as const;
