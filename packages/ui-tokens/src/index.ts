...
export const tokens = {
  ...
  type: {
    ...
    scale: {
      ...
      h3:      { size: 16, weight: 600, line: 1.40, track: "0" },
      body:    { size: 15, weight: 400, line: 1.60, track: "0" },
      small:   { size: 13, weight: 400, line: 1.50, track: "0" },
      caption: { size: 12, weight: 500, line: 1.40, track: "0.01em" },
    },
  },
  // 4px unit scale. Stick to these values.
  space: { 0: 0, 1: 4, 2: 8, 3: 12, 4: 16, 5: 20, 6: 24, 8: 32, 10: 40, 12: 48, 16: 64, 20: 80, 24: 96 } as const,
  // Motion
  motion: {
