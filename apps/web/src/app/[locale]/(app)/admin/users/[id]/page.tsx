...
import { AdminUserDetail, type AdminUserDetail as AdminUserDetailValue } from "@baydar/shared";
...
export default function AdminUserDetailPage(): JSX.Element {
  ...
  return (
    <main className="max-w-admin mx-auto w-full px-4 py-6" data-testid="admin-user-detail">
