    ...
    <>
      {error ? (
        <div className="border-line-soft border-t px-3 py-2">
          <Alert kind="danger" className="rounded-md" body={error} />
        </div>
      ) : null}
      ...
      >
        <textarea
          ...
          rows={1}
          maxLength={5000}
          className="border-line-soft bg-surface text-ink placeholder:text-ink-muted focus-visible:border-brand-600 focus-visible:outline-hidden min-h-10 flex-1 resize-none rounded-full border px-4 py-2.5 text-sm focus-visible:[box-shadow:var(--focus-ring)]"
          onKeyDown={(event) => {
        ...
        <div className="border-line-soft bg-surface border-t p-3">
          <div className="mx-auto flex max-w-3xl flex-col gap-2">
            ...
            <textarea
              ...
              className="border-line-hard text-ink focus-visible:border-brand-600 focus-visible:outline-hidden min-h-20 rounded-md border bg-transparent px-3 py-2 text-sm focus-visible:[box-shadow:var(--focus-ring)]"
              maxLength={5000}
            />
