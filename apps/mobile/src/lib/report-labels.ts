  ...
  return useMemo(
    () => ({
      ...
      reasons: {
        ...
        [ReportReason.FEE_REQUEST]: t("safety.report.reason.fee_request"),
        [ReportReason.GHOST_JOB]: t("safety.report.reason.ghost_job"),
        [ReportReason.ID_REQUEST]: t("safety.report.reason.id_request"),
