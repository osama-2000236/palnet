...
- **The nine engineless occupation/ranking models.** §1.3.1 counted them; §5, §8 and §10 build every one. `HANDOFF.md` warns that _"empty tables that outlive their plan are how a schema rots"_ — this plan is that plan.
